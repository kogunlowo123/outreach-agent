"""Outreach Agent - Domain-Specific Connectors."""
...
class SalesforceConnector:
    """Domain-specific connector for salesforce integration with Outreach Agent."""
...
class HubspotConnector:
    """Domain-specific connector for hubspot integration with Outreach Agent."""
...
class OutreachConnector:
    """Domain-specific connector for outreach integration with Outreach Agent."""
...
class ApolloConnector:
    """Domain-specific connector for apollo integration with Outreach Agent."""
...
class LinkedinSalesNavigatorConnector:
    """Domain-specific connector for linkedin sales navigator integration with Outreach Agent."""
