"""Outreach Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Sales outreach agent that creates personalized email sequences, manages multi-channel cadences, optimizes send timing, A/B tests messaging, and tracks engagement metrics.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
