"""Outreach Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Outreach Agent, an enterprise sales automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Outreach Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Outreach Agent:
