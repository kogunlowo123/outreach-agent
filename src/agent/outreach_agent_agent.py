"""Outreach Agent - Main Agent Implementation."""
...
class OutreachAgentAgent:
    ...
    def __init__(self):
        ...
        self.outreach_enabled = True
        self.analytics_enabled = True
        self.automation_enabled = True
        self._tool_dispatch = {
            "create_sequence": self.tools.create_sequence,
            "personalize_message": self.tools.personalize_message,
            "schedule_send": self.tools.schedule_send,
            "track_engagement": self.tools.track_engagement,
            "ab_test_messaging": self.tools.ab_test_messaging,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['outreach', 'analytics', 'automation'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "ab_test_messaging": ['ab', 'test', 'messaging'],
        }
